...
var calculateRampUp = function (owner, repo) { return __awaiter(void 0, void 0, void 0, function () {
    var contributors, stars, forks, firstCommitTime, weights, contributorsContribution, starsContribution, forksContribution, rampUpScore, currentTime, firstCommitTimestamp, timeDifference, maxTimeDifference, normalizedTimeDifference, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, (0, RampUpAPI_1.fetchRepositoryContributors)(owner, repo)];
            case 1:
                contributors = _a.sent();
                return [4 /*yield*/, (0, RampUpAPI_1.fetchRepositoryStars)(owner, repo)];
            case 2:
                stars = _a.sent();
                return [4 /*yield*/, (0, RampUpAPI_1.fetchRepositoryForks)(owner, repo)];
            case 3:
                forks = _a.sent();
                return [4 /*yield*/, (0, RampUpAPI_1.fetchFirstCommitTime)(owner, repo)];
            case 4:
                firstCommitTime = _a.sent();
                weights = {
                    Contributors: 0.3,
                    Stars: 0.2,
                    Forks: 0.2,
                ...
                contributorsContribution = weights.Contributors * contributors.length;
                starsContribution = weights.Stars * stars.length;
